...
--select * from autoracle.empleado;
--select * from all_users;
/* --PRUEBA
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_CREAR_EMPLEADO('Pepe','Loros','Queso','Mecanico');
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_BORRAR_EMPLEADO('10080');
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_MODIFICAR_EMPLEADO('10100','Jose','Crespo','Garcia',sysdate,0,2500,50,'ADMINISTRATIVO',2);
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_BLOQUEAR_USUARIO('PEPE_LOROS_QUESO');
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_DESBLOQUEAR_USUARIO('PEPE_LOROS_QUESO');
connect PEPE_LOROS_QUESO;
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_BLOQUEAR_TODOS_EMPLEADOS;
execute AUTORACLE.PKG_GESTION_EMPLEADOS.PR_DESBLOQUEAR_TODOS_EMPLEADOS;
*/
