...
Insert into AUTORACLE.EMPLEADO (IDEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,FECENTRADA,DESPEDIDO,SUELDOBASE,HORAS,PUESTO,RETENCIONES) values ('23','Felipe','Sexto','Brobén',to_date('22/03/20','DD/MM/RR'),'1','1100','35','Administrativo',null);
